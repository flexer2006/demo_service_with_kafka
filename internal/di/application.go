...
import (
	...
	"github.com/flexer2006/orders-api/internal/adapters/cache"
	"github.com/flexer2006/orders-api/internal/adapters/db/postgres"
	"github.com/flexer2006/orders-api/internal/adapters/db/postgres/connect"
	consumer "github.com/flexer2006/orders-api/internal/adapters/kafka"
	"github.com/flexer2006/orders-api/internal/adapters/server"
	"github.com/flexer2006/orders-api/internal/adapters/server/handlers"
	"github.com/flexer2006/orders-api/internal/app/order"
	...
	"github.com/flexer2006/orders-api/internal/shutdown"
)
...
func NewHTTPServer(cache ports.Cache, repo ports.OrderRepository, log logger.Logger, cfg config.ServerConfig) ports.HTTPServer {
	...
	httpSrv.RegisterRoutes(handlers.OrderHandler(cache, repo, log))
	return httpSrv
}
...
func NewGracefulShutdown(cfg config.ShutdownConfig, log logger.Logger) func(context.Context, ...func(context.Context) error) {
	return func(ctx context.Context, hooks ...func(context.Context) error) {
		shutdown.Wait(ctx, cfg.Timeout, log, hooks...)
	}
}
